<div class="flex mb-3 flex-col md:flex-row">
    <div class="w-full order-2 md:order-1 md:w-4/5 rounded overflow-hidden shadow-lg">
        <div class="px-6 py-4">
{{--            <div class="font-bold text-xl mb-2">Filtros de Busqueda</div>--}}
    ...
    <div class="px-3 mb-2 md:mb-0 md:px-0 md:ml-5 w-full md:w-1/5 order-1 md:order-2">
