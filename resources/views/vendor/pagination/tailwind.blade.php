                            ...
                            @if (is_array($element))
                                @foreach ($element as $page => $url)
                                    @if ($page == $paginator->currentPage())
                                        <span aria-current="page" class="hover:cursor-not-allowed">
                                            <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium bg-blue-400 text-white border border-blue-400 cursor-default leading-5">{{ $page }}</span>
                                        </span>
                                    @else
