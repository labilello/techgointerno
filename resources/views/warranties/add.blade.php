    ...
    @csrf
        ...
        <div class="grid gap-4 grid-cols-12">
            ...
            <div class="col-span-12 md:col-span-8 col-start-1"> {{-- LADO IZQUIERDO --}}
                <div class="mb-4" x-data="handler()"> {{-- LISTA EQUIPOS --}}
                ...
                <div class="mb-4" x-data="handler()"> {{-- Acciones Cliente --}}
                    <div class="flex justify-between"> {{-- HEADER --}}
                    ...
                    <ul class="">
                        ...
                        <template x-for="(field, index) in fields" :key="index">
                            <li class="flex text-sm mb-1">
                                <select class="rounded py-1 px-2 border-2 border-solid" x-bind:name=`actions[${index}][actionType]`>
                                    <option>- Sin seleccion -</option>
                                    <option>Recepcionables</option>
                                    <option>No Recepcionables</option>
                                </select>
                                <select class="rounded py-1 px-2 w-full border-2 border-solid w-full mx-2" x-bind:name=`actions[${index}][actionValue]` required>
