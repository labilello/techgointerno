<x-app-layout>
    ...
    <div class="container">
        <h1 class="h1 text-uppercase font-weight-bolder">Apple</h1>
...
{{--                        <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>--}}
                        <tbody class="align-middle">
                            <tr>
                                ...
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Compumundo</small></td>
                            </tr>
                            <tr>
                ...
                <div class="row">
                    <div class="mb-1 col-6 col-md-12">
                        ...
                        <dl class="row">
                            ...
                            <dd class="col-sm-7">
                                <a href="https://support.apple.com/es-es/contact" class="d-block">Chat - Email</a>
                            </dd>
                        </dl>
                    </div>
