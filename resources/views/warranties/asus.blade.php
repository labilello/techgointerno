<x-app-layout>
    ...
    <div class="container">
        <h1 class="h1 text-uppercase font-weight-bolder">Asus</h1>

        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>¡ATENCIÓN!</strong> Los equipos fuera de garantía quedan sujetos a disponibilidad de piezas en el páis
                ...
                <div class="row">
                    <div class="mb-1 col-6 col-md-12">
                        ...
                        <dl class="row">
                            ...
                            <dd class="col-sm-7">
                                <a href="tel:08001220563" class="d-block">0800-122-0563</a>
                            </dd>

                            <dt class="col-sm-5">En línea</dt>
                            <dd class="col-sm-7">
                                <a href="https://www.asus.com/support/Product/ContactUs/Services/questionform/?lang=es-ar" class="d-block">Email</a>
                            </dd>
                        </dl>
                    </div>
