<x-app-layout>
    ...
    <div class="container">
        <h1 class="h1 text-uppercase font-weight-bolder">Audiologic</h1>
...
{{--                        <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>--}}
                        <tbody class="align-middle">
                            <tr>
                                <td class="font-weight-bold text-black-50">Reproductores DVD</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><small>Compumundo - Garbarino</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">Microcomponentes</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><small>Compumundo - Garbarino</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">Parlantes</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><small>Compumundo - Garbarino</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">LCD/LED</td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Compumundo - Garbarino</small></td>
                            </tr>
...
{{--                    <small class="text-muted">Momentaneamente no se permiten ingresos de equipos para esta marca</small>--}}
                ...
                <div class="mb-4">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item list-group-item-action bg-success text-white"><small class="font-weight-bold text-uppercase mr-2">(Reproductores DVD)</small>Enviar equipo a Camacua.</li>
                        <li class="list-group-item list-group-item-action bg-danger text-white"><small class="font-weight-bold text-uppercase mr-2">(Otros)</small>Generar nota de cambio en sucursal de origen.</li>
                    </ul>
                </div>
