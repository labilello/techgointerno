<x-app-layout>
    ...
    <div class="container">
        <h1 class="h1 text-uppercase font-weight-bolder">Blu</h1>
...
{{--                    <small class="text-muted">Momentaneamente no se permiten ingresos de equipos para esta marca</small>--}}
                ...
                <div class="mb-4">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item list-group-item-action bg-success text-white"><small class="font-weight-bold text-uppercase mr-2">(garantía)</small>Sucursales INTERIOR generar autorizacion de cambio; Sucursales AMBA enviar a Camacua.</li>
