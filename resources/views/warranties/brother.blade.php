<x-app-layout>
    ...
    <div class="container">
        <h1 class="h1 text-uppercase font-weight-bolder">Brother</h1>
...
{{--                        <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>--}}
                        <tbody class="align-middle">
                            <tr>
                                <td class="font-weight-bold text-black-50">Impresoras</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Cualquier retail - Argentina</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">Máquinas de coser y bordar</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Cualquier retail - Argentina</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">Scanners</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Cualquier retail - Argentina</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">Rotuladoras y Etiquetadoras</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Cualquier retail - Argentina</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">ScanNCut</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Cualquier retail - Argentina</small></td>
                            </tr>
                ...
                <div class="row">
                    <div class="mb-1 col-6 col-md-12">
                        ...
                        <dl class="row">
                            ...
                            <dd class="col-sm-7">
                                <a href="tel:08102227684" class="d-block">0810-222-7684</a>
                            </dd>

                            <dt class="col-sm-5">En línea</dt>
                            <dd class="col-sm-7">
                                <a href="https://www.brother.com.ar/contactenos" class="d-block">Email</a>
                            </dd>
                        </dl>
                    </div>
                    ...
                    <div class="mb-1 col-6 col-md-12">
                        ...
                        <dl class="row">
                            ...
                            <dd class="col-sm-7">
                                <a href="https://brotherargentina.force.com/cas/login" class="d-block">Brother</a>
                            </dd>
                        </dl>
                    </div>
                </div>
