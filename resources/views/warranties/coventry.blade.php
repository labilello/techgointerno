<x-app-layout>
    ...
    <div class="container">
        <h1 class="h1 text-uppercase font-weight-bolder">Coventry</h1>
...
{{--                        <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>--}}
                        <tbody class="align-middle">
                            <tr>
                                <td class="font-weight-bold text-black-50">Purificadores</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><small>Compumundo - Garbarino</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">Cavas de vinos</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><small>Compumundo - Garbarino</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">Lavavajillas</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><small>Compumundo - Garbarino</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">Jarras Termica</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><small>Compumundo - Garbarino</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">Tostadoras</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><small>Compumundo - Garbarino</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">Cafeteras</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><small>Compumundo - Garbarino</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">Aire acondicionados</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><small>Compumundo - Garbarino</small></td>
                            </tr>
