<x-app-layout>
    ...
    <div class="container">
        <h1 class="h1 text-uppercase font-weight-bolder">Datsun</h1>

        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>¡ATENCIÓN!</strong> A excepcion de otras marcas, los Smartphones de esta marca poseen un periodo de garantía de <strong>6 MESES</strong>
...
{{--                        <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>--}}
                        <tbody class="align-middle">
                            <tr>
                                <td class="font-weight-bold text-black-50">Smartphones</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
...
{{--                    <small class="text-muted">Momentaneamente no se permiten ingresos de equipos para esta marca</small>--}}
                ...
                <div class="mb-4">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item list-group-item-action"><small class="font-weight-bold text-uppercase mr-2">(garantía - Fuera de garantía)</small>Enviar a Camacua modelos D5001 y D5500.</li>
