            ...
            <div class="col-span-12 md:col-span-8 col-start-1"> {{-- LADO IZQUIERDO --}}
                ...
                @if( count($warranty->devices) > 0)
                    <div class="mb-4"> {{-- LISTA EQUIPOS --}}
                        ...
                        <h4 class="text-lg sm:text-2xl font-semibold text-green-500 mb-2">Lista de equipos</h4>
                        <table class="table-auto w-full mb-1">
                            <thead>
                                <tr class="text-xs sm:text-base border-b-2 border-green-600 border-t">
                            ...
                            <tbody class="text-xs sm:text-sm text-gray-700">
                ...
                @if( count($warranty->actions) > 0)
                    <div class="mb-4"> {{-- Acciones Cliente --}}
                        <h4 class="text-lg sm:text-2xl font-semibold text-green-500 mb-2">Acciones al recibir un cliente</h4>

                        {{-- BODY --}}
                        <ul class="text-gray-700 text-xs sm:text-base border rounded border-opacity-0 border-gray-700">
                ...
                @if( count($warranty->documents) > 0)
                    <div class="mb-4"> {{-- Documentacion --}}
                        <h4 class="text-lg sm:text-2xl font-semibold text-green-500 mb-2">Documentación necesaria</h4>
