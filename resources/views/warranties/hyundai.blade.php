<x-app-layout>
    ...
    <div class="container">
        <h1 class="h1 text-uppercase font-weight-bolder">Hyundai</h1>

        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>¡ATENCIÓN!</strong> Actualmente las reparaciones para esta marca se encuentran con demoras
...
{{--                    <small class="text-muted">Momentaneamente no se permiten ingresos de equipos para esta marca</small>--}}
                ...
                <div class="mb-4">
                    ...
                    <ul class="list-group">
{{--                        <li class="list-group-item list-group-item-action bg-danger text-white"><small class="font-weight-bold text-uppercase mr-2">(No recepcionables)</small>Indicar al cliente que debe comunicarse con el contact center para ser derivado a otro centro de servicio.</li>--}}
                        <li class="list-group-item list-group-item-action bg-success text-white"><small class="font-weight-bold text-uppercase mr-2">(Recepcionables)</small>Recepción del equipo en Solnik.</li>
                ...
                <div class="row">
                    <div class="mb-1 col-6 col-md-12">
                        ...
                        <dl class="row">
                            ...
                            <dd class="col-sm-7">
                                <a href="tel:08108106000" class="d-block">0810-810-6000</a>
                            </dd>

                            <dt class="col-sm-5">En línea</dt>
                            <dd class="col-sm-7">
                                <a href="https://www.nokia.com/phones/es_ar/support" class="d-block">Chat - Email</a>
                            </dd>
                        </dl>
                    </div>
