<x-app-layout>
    ...
    <div class="container">
        <h1 class="h1 text-uppercase font-weight-bolder">Productos de Outlet</h1>
...
{{--                        <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>--}}
                        <tbody class="align-middle">
                            ...
                            <tr>
                                <td class="font-weight-bold text-black-50">LG Q6 - LGM700AR</td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Cualquier retail - Argentina</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">LG G6 - LGH870AR</td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Cualquier retail - Argentina</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">LG G7 - LMG710RM</td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Cualquier retail - Argentina</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">LG K40 - LMX420HM</td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Cualquier retail - Argentina</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">LG K50 - LMX520HM</td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Cualquier retail - Argentina</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">LG Q60 - LGX525</td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Cualquier retail - Argentina</small></td>
                            </tr>
                ...
                <div class="row">
                    <div class="mb-1 col-6 col-md-12">
                        ...
                        <dl class="row">
                            ...
                            <dd class="col-sm-7">
                                <a href="tel:08008885454" class="d-block">0800-888-5454</a>
                            </dd>

                            <dt class="col-sm-5">Whatsapp</dt>
                            <dd class="col-sm-7">
                                <a href="tel:1130158095" class="d-block">11-3015-8095</a>
                            </dd>

                            <dt class="col-sm-5">En línea</dt>
                            <dd class="col-sm-7">
                                <a href="https://www.lg.com/ar/soporte/chat-email" class="d-block">Chat - Email</a>
                            </dd>
                        </dl>
                    </div>
