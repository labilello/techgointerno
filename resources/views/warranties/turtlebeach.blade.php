<x-app-layout>
    ...
    <div class="container">
        <h1 class="h1 text-uppercase font-weight-bolder">Turtle Beach</h1>
                ...
                <div class="table-responsive">
                    <table class="table table-sm ">
                        ...
                        <tbody class="align-middle">
                            <tr>
                                <td class="font-weight-bold text-black-50">Auricular Ear Force PLA TBS-3006-01</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Distribuidor autorizado</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">Auricular PX24 TBS-3330-01</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Distribuidor autorizado</small></td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-black-50">Auricular Recon 60P TBS-3308-01</td>
                                <td class="text-center"><i class="fas fa-check-circle text-success h5"></i></td>
                                <td class="text-center"><i class="fas fa-times-circle text-danger h5"></i></td>
                                <td class="text-center"><small>Distribuidor autorizado</small></td>
                            </tr>
